...
@InternalAtlasApi
public fun AtlasExtensionImpl.orderedProjectTypes(): List<ProjectTypeSpec> =
...
@InternalAtlasApi
public fun projectType(type: ProjectTypeSpec): ProjectType =
  ProjectType(
    name = type.name,
...
@InternalAtlasApi
public fun linkType(type: LinkTypeSpec): LinkType =
  LinkType(
...
@InternalAtlasApi
public inline fun <reified E> ObjectFactory.enum(convention: E?): Property<E>
  where E : StringEnum, E : Enum<E> = property(E::class.java).convention(convention)

@InternalAtlasApi
public inline fun <reified E> ObjectFactory.enum(convention: Provider<E>): Property<E>
  where E : StringEnum, E : Enum<E> = property(E::class.java).convention(convention)

@InternalAtlasApi
public inline fun <reified E> ObjectFactory.intEnum(convention: Provider<E>): Property<E>
