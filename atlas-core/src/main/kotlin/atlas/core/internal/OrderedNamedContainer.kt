...
@InternalAtlasApi
public open class LinkTypeContainer<T : LinkTypeSpec>(delegate: NamedDomainObjectContainer<T>) :
...
public open class OrderedNamedContainer<T : Any>(
  ...
  // No idea what this is for but if I don't have it I get a linting warning on the interface
