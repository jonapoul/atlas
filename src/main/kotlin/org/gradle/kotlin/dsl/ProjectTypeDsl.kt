...
@JvmOverloads
public fun NamedProjectTypeContainer.androidApp(
...
@JvmOverloads
public fun NamedProjectTypeContainer.androidLibrary(
...
@JvmOverloads
public fun NamedProjectTypeContainer.java(
  name: String = "Java",
  color: String? = "orange",
  action: Action<ProjectTypeSpec>? = null,
): NamedDomainObjectProvider<ProjectTypeSpec> =
...
@JvmOverloads
public fun NamedProjectTypeContainer.kotlinJvm(
...
@JvmOverloads
public fun NamedProjectTypeContainer.kotlinMultiplatform(
...
/**
 * Adds an "Other" project type, with a grey color. This will match anything and everything, so make
 * sure to declare this last in the projectTypes block from your build file.
 */
@JvmOverloads
public fun NamedProjectTypeContainer.other(
  name: String = "Other",
...
public fun NamedProjectTypeContainer.useDefaults() {
  // Highest priority ↓↓
  androidApp()
  kotlinMultiplatform()
  androidLibrary()
